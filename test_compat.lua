...
assert(utf8.char(0, utf8.byte("\228"), 0) == utf8.escape"%0%xe4%0")
assert(utf8.char(utf8.byte("\228l\0óu", 1, -1)) == utf8.escape"%xe4l\0óu")
assert(utf8.char(utf8.byte("\228l\0óu", 1, 0)) == "")
assert(utf8.char(utf8.byte("\228l\0óu", -10, 100)) == utf8.escape"%xe4l\0óu")
print('+')
